            ...
            <div className="w-full text-center space-y-1.5 sm:space-y-5">
              ...
              <div className="mx-auto grid max-w-[18rem] sm:max-w-sm grid-cols-2 gap-2 sm:gap-4 -mt-1 sm:-mt-2 text-center">
                <div>
                  ...
                  <p className="font-display text-[11px] sm:text-lg text-gold-deep leading-tight">October 31 2026</p>
                ...
                <div>
                  ...
                  <p className="font-display text-[10px] sm:text-base text-gold-deep leading-tight">
                    Swaneset Bay
                    <br />
                    Resort &amp; Country Club
                  </p>
